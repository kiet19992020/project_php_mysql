    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">Nguyen Kiet</span>
                <b class="caret"></b>
            </a>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-category-product')}}">Thêm Danh Mục Sản Phẩm</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-brand-product')}}">Thêm thương hiệu Sản Phẩm</a></li>
                        <li><a href="{{URL::to('/all-brand-product')}}">Liệt kê thương hiệu Sản Phẩm</a></li>
                    </ul>
                </li>
                {{-- THÊM THƯƠNG HIỆU SẢN PHẨM --}}
                {{-- THÊM SẢN PHẨM --}}
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{URL::to('/all-product')}}">Liệt Kê Sản Phẩm</a></li>
                    </ul>
                </li>
                {{-- THÊM SẢN PHẨM --}}
                <li class="sub-menu">
